...
origin: ECC
---
<!-- Source: ecc@2.0.0-rc.1, vendored on 2026-05-16 from skills/skill-stocktake/SKILL.md -->
...
- For **Retire**: state (1) what specific defect was found, (2) what covers the same need instead
  - Bad: `"Superseded"`
  - Good: `"disable-model-invocation: true already set; superseded by verification-loop which covers all the same patterns plus confidence scoring. No unique content remains."`
